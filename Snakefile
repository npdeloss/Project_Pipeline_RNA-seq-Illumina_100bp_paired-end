...
rule all:
	input:
		"QC_fastqc/H_sapiens/JGF001_S1_L001_R1",
		"Alignment_STAR/H_sapiens/GRCh38/JGF001_S1_L001/Aligned.out.bam",
		"QC_RSeQC/H_sapiens/GRCh38/JGF001_S1_L001",
		"Quantification_RSEM/H_sapiens/GRCh38/JGF001_S1_L001/Quant.genes.results"
...
rule QC_RSeQC:
	...
	shell:
		...
		{rseqc_bin}/geneBody_coverage.py -i ../../../../{input.unsorted_BAM} -r ../../../../{input.RSeQC_reference_bed} -o out &> out.geneBody_coverage.log & 
